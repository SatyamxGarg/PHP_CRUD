...
$mail->Body = "
<h2>Hello</h2>
<h3>You are receiving this email because we reveived a password reset request for your account.</h3>
<a href = 'http://localhost/Crud_design/password-change.php?token=$token&email=$get_email'>Click Me </a>
";
// Send email
$mail->send();
